...
import { makeProjector, projectorFor } from '../../app/lib/pdf-report/projector.mjs'
import {
  effectiveDpi,
  ...
  tileTopLeft,
  tilesCovering
} from '../../app/lib/pdf-report/grid.mjs'
...
test('the graticule interval is derived from the grid, never read off a tile', async () => {
  const { gridIntervalMetres, syntheticTileSource } = await import('../../app/lib/pdf-report/tiles.mjs')
