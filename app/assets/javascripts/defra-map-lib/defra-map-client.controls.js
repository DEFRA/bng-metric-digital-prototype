...
(function(window) {
  ...
  const ICONS = {
    ...
    // Slice/Knife icon
    slice: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 2l18 18"></path><path d="M21 2L8.6 14.4"></path><path d="M15.5 8.5L19 5"></path><path d="M8.6 14.4c-1.2 1.2-3.1 1.2-4.2 0-1.2-1.2-1.2-3.1 0-4.2"></path></svg>`,
